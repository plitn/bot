...
inline_btn_restart = InlineKeyboardButton('Пройти вопросы заново', callback_data='restart_btn')
...
inline_restart = InlineKeyboardMarkup(row_width=1)
inline_restart.add(inline_btn_restart)
